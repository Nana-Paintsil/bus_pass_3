...
*/
  static TimeSpan? fromJson(String value) {
  ...
  static List<TimeSpan> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<TimeSpan>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = TimeSpan.listFromJson(
          entry.value,
          growable: growable,
        );
      }
