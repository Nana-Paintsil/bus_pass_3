...
class ApiClient {
  ApiClient({
    this.basePath = 'https://buspassapi.azurewebsites.net',
    this.authentication,
  });
  ...
  static dynamic _deserialize(dynamic value, String targetType,
    ...
    try {
      switch (targetType) {
        ...
        case 'BusTicket':
          return BusTicket.fromJson(value);
        case 'Journey':
          return Journey.fromJson(value);
        case 'Pass':
          return Pass.fromJson(value);
        case 'PassJourney':
          return PassJourney.fromJson(value);
        case 'Stop':
          return Stop.fromJson(value);
        case 'TblUser':
          return TblUser.fromJson(value);
        case 'Tenant':
        ...
        case 'UserAuth':
          return UserAuth.fromJson(value);
        case 'UserCred':
          return UserCred.fromJson(value);
        default:
          dynamic match;
          if (value is List &&
